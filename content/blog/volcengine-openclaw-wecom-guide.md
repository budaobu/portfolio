...
从 ClawdBot 卸载重装切换到 OpenClaw 后，遭遇了配置失效、网络不通、企微回调失败等一系列问题，耗时一天完成全流程调试，最终成功打通企业微信机器人对接。本文记录部分部署、配置、排障流程，帮你避开同款坑点。
...
### 问题4：认证企业微信无法使用IP回调
1. 企业微信未认证主题可使用IP回调
2. 企业微信认证主体强制要求**备案主体一致的域名**，需完成域名备案并解析至服务器公网IP。

整套流程完成后，在企业微信后台点击那个「创建」，跳转了机器人创建成功的页面，这时候企业微信机器人就可正常接收消息、调用火山方舟大模型返回应答，完成全链路打通。
