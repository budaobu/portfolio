    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
      ...
      <div class="lg:col-span-2 flex flex-col h-full">
        ...
        <div 
          ...
          :class="[
            'flex-1 border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center text-center transition-colors duration-150 ease-out cursor-pointer min-h-[260px] shadow-sm group',
            isDragging 
