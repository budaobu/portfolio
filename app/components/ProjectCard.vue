<template>
  <div class="group relative h-full bg-warm-50 dark:bg-olive-900 border border-warm-200 dark:border-warm-800 p-6 transition-all duration-300 hover:border-coral-500/50 dark:hover:border-coral-500/50 over:bg-warm-100 dark:hover:bg-olive-800">
